...
public record ClienteJuridicoDto (String cnpj, Long id, String ie, List<Contato> contatos, boolean ativo, Empresa empresa){

    public ClienteJuridicoDto(ClienteJuridico clienteJuridico) {
        this(clienteJuridico.getCnpj(), clienteJuridico.getId(), clienteJuridico.getIe(), clienteJuridico.getContatos(),clienteJuridico.isAtivo(), clienteJuridico.getEmpresa());
    }
